                ...
                <div className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-xl overflow-hidden">
                    ...
                    <div className="p-6 space-y-5 text-sm">
                        <div className="flex justify-between">
                            <span className="text-[#8d90a2]">Status</span>
                            <span className="text-[#e5e2e1] capitalize font-medium">{rental.status}</span>
                        </div>

                    <div className="flex justify-between">
                        <span className="text-[#8d90a2]">Dates</span>
                        <span className="text-[#e5e2e1]">
                            {new Date(rental.startDate).toLocaleDateString()} - {new Date(rental.endDate).toLocaleDateString()}
                        </span>
                    </div>
                    <div className="flex justify-between">
                        <span className="text-[#8d90a2]">Rental amount</span>
                    ...
                    <div className="flex justify-between pt-1">
                        <span className="text-[#8d90a2]">Paid</span>
